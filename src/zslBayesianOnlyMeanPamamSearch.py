...
def createModel(param1, param2, param3,
                data=None,
                classFeatures=None,
    ...
    modelSig = Ridge(alpha = param2)
    modelEmpV = Ridge(alpha = param3)
    ...
    for i in unseenList:
        ...
        for j in range(min(20, countsTest[i])):
...
param = [32500, 100000, 325000]
for i in param:
  for j in param:
    for k in param:
      print("starting : {}".format(j+1))
      pred = createModel(param1 = i, param2 = j, param3=k)
